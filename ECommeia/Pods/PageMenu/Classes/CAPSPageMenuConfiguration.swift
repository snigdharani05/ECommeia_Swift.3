...
public class CAPSPageMenuConfiguration {
    ...
    open var unselectedMenuItemLabelColor : UIColor = UIColor.blue
    open var scrollMenuBackgroundColor : UIColor = UIColor.lightGray
    open var viewBackgroundColor : UIColor = UIColor.white
    open var bottomMenuHairlineColor : UIColor = UIColor.red
    open var menuItemSeparatorColor : UIColor = UIColor.blue
