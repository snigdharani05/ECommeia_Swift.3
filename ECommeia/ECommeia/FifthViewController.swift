...
class FifthViewController: UIViewController , UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    @IBOutlet weak var fastfoodDeliveryCollectionView: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        fastfoodDeliveryCollectionView.delegate = self
        fastfoodDeliveryCollectionView.dataSource = self
        fastfoodDeliveryCollectionView.register(UICollectionViewCell.self, forCellWithReuseIdentifier: "mycell")
        let nib = UINib(nibName: "HomeCollectionViewCell", bundle: nil)
        fastfoodDeliveryCollectionView.register(nib, forCellWithReuseIdentifier: "mycell")
        fastfoodDeliveryCollectionView?.allowsMultipleSelection = true
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        var mycell : HomeCollectionViewCell! = fastfoodDeliveryCollectionView.dequeueReusableCell(withReuseIdentifier: "mycell", for: indexPath) as! HomeCollectionViewCell
        if(mycell == nil) {
